...
private Connection conexao=null;
    ...
    public boolean insert(Produto produto){ 
        ...
        statement.setString(2, produto.getProduto());
        statement.setDouble(3, produto.getValor());
        statement.setInt(4, produto.getDisponivel());
    ...
    public List<Produto> select(){ 
         ...
         try{
             ...
             produto.setProduto(resultset.getString("nomeProduto"));
             produto.setValor(resultset.getDouble("valor"));
             produto.setDisponivel(resultset.getInt("Disponivel"));
